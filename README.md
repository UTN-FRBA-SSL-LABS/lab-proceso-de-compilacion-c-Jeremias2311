...
> **R:Porque el preprocesador expande el código fuente, incorporando el contenido de las directivas y reemplazando macros,lo cual produce un aumento significativo en la cantidad de líneas**
...
> **R:El numero de linea y el archivo de donde proviene.proviene de "c:\\mingw\\include\\stdio.h"**
...
> **R:Empieza la funcion _sumar y se prepara la pila para poder ejecturarla**
...
> **R:tiene tipo U en programa.o porque se necesita pero no está definida la funcion. y tiene tipo T en matematica.o porque ahi se encuentra la definicion de la funcion**
...
> **R:porque se cargan en tiempo de ejecucion , el enlazador no las copia,solo deja registrado su nombre.Lo resuelve el cargador dinamico, cuando el programa se ejecute**
...
> **R:La diferencia con una función real es que la macro se expande en tiempo de preprocesamiento. la macro funcion desaparece en la etapa de preprocesamiento y la funcion real no desaparece. la funcion reaL es la que tiene verificacion de tipos**
...
> **R:la diferencia es que un simbolo de tipo T representa codigo ejecutable y un simbolo tipo D representa datos globales.el primero vive en un .txt y el segundo en un .data**
